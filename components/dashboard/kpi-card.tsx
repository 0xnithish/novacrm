...
export function KPICard({
  ...
  return (
    <article
      className={cn(
        "group relative flex h-full min-h-[120px] flex-col justify-between overflow-hidden rounded-xl border border-border bg-card px-6 pt-5 text-card-foreground ",
        className
      )}
    >
      <div
